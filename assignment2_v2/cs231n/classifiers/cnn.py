...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        C, H, W = input_dim
        max_pool_dim = 2
        H_out = H/max_pool_dim
        W_out = W/max_pool_dim
        self.params['W1'] = np.random.normal(loc=0, scale=weight_scale, size=(num_filters, C, filter_size, filter_size))
        self.params['b1'] = np.zeros(num_filters)
        self.params['W2'] = np.random.normal(loc=0, scale=weight_scale, size=(int(num_filters * H_out * W_out), hidden_dim))
